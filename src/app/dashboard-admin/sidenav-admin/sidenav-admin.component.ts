  ...
  template: `
    <section>
      ...
      <ul>
        ...
        <ul [routerLink]="['/dashboard-admin/financeiro']"><i class="fas fa-dollar-sign"></i>Financeiro
          <li [routerLink]="['/dashboard-admin/financeiro']"><i class="fas fa-dollar-sign"></i>À Receber</li>
          <li [routerLink]="['/dashboard-admin/financeiro']"><i class="fas fa-dollar-sign"></i>À pagar</li>
          <li [routerLink]="['/dashboard-admin/financeiro']"><i class="fas fa-dollar-sign"></i>Fluxo Caixa Direto</li>
          <li [routerLink]="['/dashboard-admin/financeiro']"><i class="fas fa-dollar-sign"></i>Pagou X Utilizou</li>
        </ul>
