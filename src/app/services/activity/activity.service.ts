...
export class ActivityService {
  ...
  activitiesPfCount() {
    return this.http.get(this.baseUrl + '/activities-pf-count');
  }

  activitiesPjCount() {
    return this.http.get(this.baseUrl + '/activities-pj-count');
  }
  ...
  report() {
    return this.http.get(this.baseUrl + '/atividades-relatorio');
  }
